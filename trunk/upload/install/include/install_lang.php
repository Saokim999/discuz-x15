 ...
 *
 *      $Id: install_lang.php 16093 2010-08-31 07:57:44Z zhangguosheng $
 */
...
<p>電子文本形式的授權協議如同雙方書面簽署的協議一樣，具有完全的和等同的法律效力。您一旦開始安裝 Discuz!，即被視為完全理解並接受本協議的各項條款，在享有上述條款授予的權力的同時，受到相關的約束和限制。協議許可範圍以外的行為，將直接違反本授權協議並構成侵權，我們有權隨時終止授權，責令停止損害，並保留追究相關責任的權力。</p></div>',
	...
	'testdata' => '附加數據',
	'testdata_check_label' => '安裝首頁模板和完整地區數據（四級）',
	'install_data' => '正在安裝數據',
	...
	為了不斷改進產品質量，改善用戶體驗，Discuz! X《康盛改善計劃》，該系統有利於我們分析用戶在論壇的操作習慣，進而幫助我們在未來的版本中對產品進行改進，設計出更符合用戶需求的新功能。
