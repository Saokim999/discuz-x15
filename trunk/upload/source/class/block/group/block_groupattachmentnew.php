 ...
 *
 *      $Id: block_groupattachmentnew.php 6994 2010-03-27 14:52:10Z xupeng $
 */
...
class block_groupattachmentnew extends block_groupattachment {
	function block_groupattachmentnew() {
		$this->settings = array(
			'gtids' => array(
	...
	function name() {
		return lang('blockclass', 'blockclass_groupattachment_script_groupattachmentnew');
	}
