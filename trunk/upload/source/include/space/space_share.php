 ...
 *
 *      $Id: space_share.php 16588 2010-09-09 10:03:36Z wangjinbo $
 */
...
if($id) {
	...
	$navtitle = lang('space', 'sb_sharing', array('who' => $space['username'])) .' - '. $_G['setting']['bbname'];
	$metakeywords = lang('space', 'sb_sharing', array('who' => $space['username']));
	$metadescription = lang('space', 'sb_sharing', array('who' => $space['username']));
