 ...
 * DiscuzX Convert
 *
 * $Id: polloptions.php 15398 2010-08-24 02:26:44Z monkey $
 */
...
if($nextid) {
	showmessage("繼續轉換數據表 ".$table_source." polloptionid > $nextid", "index.php?a=$action&source=$source&prg=$curprg&start=$nextid");
}
?>